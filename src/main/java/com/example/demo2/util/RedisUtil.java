...
public class RedisUtil {
    ...
    public void hPutAll(String key, Map<String, String> maps) {
        redisTemplate.<String, String>opsForHash().putAll(key, maps);
    }
    ...
    public Boolean hPutIfAbsent(String key, String hashKey, String value) {
        return redisTemplate.<String, String>opsForHash().putIfAbsent(key, hashKey, value);
    }
    ...
    public Long hDelete(String key, String... hashKeys) {
        return redisTemplate.<String, String>opsForHash().delete(key, hashKeys);
    }
    ...
    public boolean hExists(String key, String hashKey) {
        return redisTemplate.<String, String>opsForHash().hasKey(key, hashKey);
    }
    ...
    public Long hIncrBy(String key, String hashKey, long delta) {
        return redisTemplate.<String, String>opsForHash().increment(key, hashKey, delta);
    }
    ...
    /**
     * 根据Score值和指定范围查询集合元素, 从大到小排序
     */
    public Set<String> zReverseRangeByScore(String key,
                                            double min, double max,
                                            long start, long end) {
        return redisTemplate.opsForZSet().reverseRangeByScore(key, min, max,
                start, end);
